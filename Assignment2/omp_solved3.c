...
void print_results(float array[N], int tid, int section) 
{
  ...
  // Since this function gets called from sections. Not all threads will be reaching this point and hence
  // haviing barrier at this point doesn't make sense and hence has been commented.
  //#pragma omp barrier
