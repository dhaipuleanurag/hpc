...
#pragma omp parallel shared(a, b, nthreads, locka, lockb) private(tid)
  ...
  #pragma omp sections nowait
    ...
    #pragma omp section
      {
      // Deadlock occurs because the order in which locks are acquired in two sections are different. The locks should be acquired 
	  // in same order and must also be realized in same order.
